defmodule NixosTest.MachineConfigTest do
  use ExUnit.Case, async: true

  alias NixosTest.MachineConfig
  ...
  describe "parse_file/2" do
    test "parses QEMU machine config from JSON" do
      ...
      assert machine.backend == NixosTest.Machine.Backend.QEMU
    ...
    test "parses firecracker machine config from JSON" do
      ...
      assert machine.backend == NixosTest.Machine.Backend.Firecracker
    ...
    test "multiple machines of mixed backends" do
      ...
      assert qemu.backend == NixosTest.Machine.Backend.QEMU
      assert fc.backend == NixosTest.Machine.Backend.Firecracker
    end
